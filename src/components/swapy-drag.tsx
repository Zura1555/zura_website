...
export function TeamCard() {
  return (
    <div className="bg-primary rounded-xl p-6 h-full flex flex-col items-center justify-center shadow-md">
      <Lottie 
...
export function AgencyCard() {
  return (
    <div className="bg-gradient-to-r from-yellow to-orange-400 rounded-xl h-full p-4 relative overflow-hidden shadow-md">
      <div className="bg-gray-900 text-yellow text-lg font-medium px-4 py-2 rounded-lg inline-block mb-4 w-full">
        <p>My ongoing</p>
        <p>projects</p>
      </div>
...
export function LogoCard() {
  return (
    <div className="bg-yellow rounded-xl h-full p-6 flex flex-col items-center justify-center shadow-md">
      <Lottie 
...
export function InfluencersCard() {
  ...
  return (
    <div className="bg-white rounded-xl h-full p-4 flex flex-col justify-center shadow-md border border-primary">
      <h3 className="text-2xl font-bold mb-2 text-center text-gray-900">My Favorite</h3>
      <p className="text-3xl fontmin-500 mb-6 text-center text-gray-900">Tech Influencers</p>
      ...
      <div className="flex items-center justify-center mb-6">
        <div className="flex items-center space-x-4">
          ...
          <div className="flex flex-col max-w-[60%]">
            <p className="text-sm font-medium mb-1 text-gray-900">{currentInfluencer.name}</p>
            <p className="text-xs text-gray-900">{currentInfluencer.description}</p>
          </div>
        </div>
      </div>
...
export function CompanyCard() {
  return (
    <div className="bg-white rounded-xl h-full p-6 col-span-1 shadow-md border border-primary">
      <h2 className="text-3xl font-bold mb-1 text-gray-900">Company</h2>
      <p className="mb-6 text-gray-600">Experience</p>

      <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mt-4 sm:mt-6 sm:items-center justify-center sm:justify-start">
        <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-md bg-transparent flex items-center justify-center">
          <img 
            src="/cpa.png" 
            alt="CPA Australia" 
            className="max-w-full max-h-full object-contain rounded-lg p-2"
          ...
          <div className="grid w-full grid-cols-12 gap-2 md:gap-6">
            {initialItems.map((item) => (
              <div
                ...
                className={`rounded-lg h-64 ${item.className}`}
              >
                <div
                  data-swapy-item={item.id}
                  className="relative rounded-lg w-full h-full 2xl:text-xl text-sm cursor-move transition-transform hover:scale-105"
                >
                  {item.widgets}
                </div>
              </div>
